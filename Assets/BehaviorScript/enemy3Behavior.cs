...
public class enemy3Behavior : MonoBehaviour
{
    ...
    public GameObject bulletPrefabNegative;
    ...
    {
        // Random HP and Size
        float random = Random.Range(0.3f, 0.5f);
        healthPoints = Mathf.Round(random + 10) * centertext.stage;
    ...
    void Shoot()
    {
        ...
        if (transform.position.x < 0)
        Instantiate(bulletPrefabNegative, firePoint.position, firePoint.rotation);
    }
